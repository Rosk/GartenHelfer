<div class="terms">
<h2>ROSK HomeControl - Terms and conditions</h2><ol><li>
<p><strong>Preamble:</strong> This Agreement, signed on Jul 4, 2015 (hereinafter: Effective Date) governs the relationship between ROSK Form &amp; Funktion, a Business Entity, (hereinafter: Licensee) and ROSK Form &amp; Funktion, a private person whose principal place of business is {location} (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using ROSK HomeControl (hereinafter: The Software) created and owned by Licensor, as detailed herein</p>
</li><li>
