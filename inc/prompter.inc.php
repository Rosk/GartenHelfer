...
<?php if ($del5): ?>
    ...
    deleteTonne($del5);
    ?>
    <h4 class="well hideInTime"><?php echo $msg5; ?></h4>
<?php endif; ?>
...
<?php if ($add4): ?>
    <?php
    insertWartung($add4, 1, $add4_2, $add4_3, $add4_4);
    ?>
    <h4 class="well hideInTime"><?php echo $msg_add4; ?></h4>
<?php endif; ?>

<?php if ($add5): ?>
    <?php
    insertTonne($add5, $add5_2);
    ?>
    <h4 class="well hideInTime"><?php echo $msg_add5; ?></h4>
<?php endif; ?>
